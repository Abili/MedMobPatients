package com.raisac.medmobpatients.Dialogs;
...
public class ChangePhotoDialog extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageView selectPhoto = view.findViewById(R.id.gallery);
        ...
        //Initialize the textview for choosing an image from memory
        ImageView takePhoto = view.findViewById(R.id.camera);
